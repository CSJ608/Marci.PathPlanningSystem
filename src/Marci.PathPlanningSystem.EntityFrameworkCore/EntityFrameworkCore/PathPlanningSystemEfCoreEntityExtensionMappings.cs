...
public static class PathPlanningSystemEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PathPlanningSystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
