...
namespace Marci.PathPlanningSystem.Web.Menus;

public class PathPlanningSystemMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public PathPlanningSystemMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<PathPlanningSystemResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                PathPlanningSystemMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
